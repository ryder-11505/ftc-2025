...
class OutsideOneForDoubleSpecimen : Map {
    ...
    override val specimenPosition = Pose2d(1.0, -26.0, Math.PI / 2)
    override val specimenPosition2 = Pose2d(-2.0, -26.0, Math.PI / 2)
    override val depositPosition = Pose2d(-46.0, -58.0, Math.PI / 16)
    override val collectPosition = Pose2d(42.0, -62.25, Math.PI / 2)
